      ...
      <section className="w-full max-w-screen-2xl mx-auto px-6 md:px-20 pt-12 md:pt-20 pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h1 variants={fadeUp} className="text-5xl md:text-6xl lg:text-7xl font-serif text-[#26231F] leading-[1.1] tracking-tight">
            ...
            <motion.div variants={fadeUp} className="mt-4 flex flex-row items-center bg-white rounded-full p-1.5 sm:p-2 shadow-[0_8px_30px_rgb(0,0,0,0.04)] max-w-xl border border-[#dcc1b8]/30">
              <div className="flex-1 px-3 sm:px-4 flex items-center gap-2 border-r border-gray-100 min-w-0">
                ...
                <input type="text" placeholder="Location" className="w-full bg-transparent border-none outline-none text-xs sm:text-sm text-[#26231F] placeholder-gray-400 min-w-0" readOnly />
              </div>
              <div className="flex-1 px-3 sm:px-4 flex items-center gap-2 min-w-0">
                ...
                <input type="text" placeholder="Category" className="w-full bg-transparent border-none outline-none text-xs sm:text-sm text-[#26231F] placeholder-gray-400 min-w-0" readOnly />
              </div>
              <button className="flex shrink-0 justify-center items-center bg-[#c1613c] text-white p-2.5 sm:p-3.5 rounded-full hover:bg-[#a54f2f] transition-colors shadow-md">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 mt-6 w-full sm:w-auto">
              <button className="w-full sm:w-auto bg-[#c1613c] text-white px-8 py-4 rounded-full font-semibold hover:bg-[#a54f2f] transition-all shadow-[0_8px_20px_rgba(193,97,60,0.25)] hover:shadow-[0_12px_24px_rgba(193,97,60,0.35)] whitespace-nowrap">
                Explore Experiences
              </button>
              <button className="group w-full sm:w-auto text-[#26231F] font-semibold flex items-center justify-center sm:justify-start gap-2 hover:text-[#c1613c] transition-colors py-4 px-2 whitespace-nowrap">
                Become a Host
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 z-10 bg-white/95 backdrop-blur-md rounded-full px-5 py-2.5 flex items-center gap-2 shadow-xl border border-white/20">
              <svg className="w-4 h-4 text-[#c1613c]" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
              <span className="text-sm font-bold text-[#26231F]">4.9 <span className="font-medium text-gray-500">· 12,000+ experiences booked</span></span>
            </div>
          </motion.div>
      ...
      >
        <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-[0_20px_60px_rgb(0,0,0,0.06)] border border-[#dcc1b8]/20 flex flex-col lg:flex-row justify-between items-center gap-10">
          ...
          <div className="text-center lg:text-left">
            <h3 className="text-3xl font-serif text-[#26231F] mb-2">Find your kind of hands-on.</h3>
            <p className="text-[#55433c]">Explore featured categories.</p>
          </div>

          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            <button className="flex flex-col items-center justify-center gap-3 w-28 h-28 rounded-2xl border border-gray-100 bg-white hover:border-[#c1613c] hover:shadow-lg transition-all group">
              <svg className="w-8 h-8 text-[#c1613c] group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
              </svg>
              <span className="text-xs font-bold text-[#26231F] tracking-wide">Cooking</span>
            </button>
            ...
            <button className="flex flex-col items-center justify-center gap-3 w-28 h-28 rounded-2xl border border-gray-100 bg-white hover:border-[#c1613c] hover:shadow-lg transition-all group">
              ...
              <span className="text-xs font-bold text-[#26231F] tracking-wide">Pottery</span>
            </button>
            ...
            <button className="flex flex-col items-center justify-center gap-3 w-28 h-28 rounded-2xl border border-gray-100 bg-white hover:border-[#c1613c] hover:shadow-lg transition-all group">
              ...
              <span className="text-xs font-bold text-[#26231F] tracking-wide">Art</span>
            </button>
            ...
            <button className="flex flex-col items-center justify-center gap-3 w-28 h-28 rounded-2xl border border-gray-100 bg-white hover:border-[#c1613c] hover:shadow-lg transition-all group">
              ...
              <span className="text-xs font-bold text-[#26231F] tracking-wide">Outdoors</span>
            </button>
          </div>
