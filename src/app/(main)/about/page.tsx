  ...
  return (
    <div className="w-full bg-surface flex flex-col items-center">
      ...
      <section className="relative w-full h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-ink/40 mix-blend-overlay" />
        
        <motion.div 
          initial="hidden"
          animate="show"
          variants={fadeUp}
          className="relative z-10 text-center max-w-4xl bg-surface/90 p-10 md:p-16 rounded-[2rem] backdrop-blur-md shadow-[0_20px_60px_rgba(38,35,31,0.15)] mx-6"
        >
          <h1 className="text-4xl md:text-6xl font-serif text-ink mb-6 leading-tight">
            Why we started <span className="italic text-primary">Alcove</span>
          </h1>
      ...
      <section className="w-full max-w-screen-2xl mx-auto px-6 md:px-20 py-24 md:py-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-serif text-ink leading-tight">
              Our Story
            </motion.h2>
      ...
      <section className="w-full bg-secondary rounded-t-[3rem] py-24 md:py-32 px-6 md:px-20 relative z-20 shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
        <div className="max-w-screen-2xl mx-auto">
          ...
          >
            <span className="text-xs font-bold tracking-[0.2em] text-surface/70 uppercase mb-4 block">
              What drives us
            </span>
            <h2 className="text-4xl md:text-5xl font-serif text-surface">Our Values</h2>
          </motion.div>
          ...
          >
            {/* Value 1 */}
            <motion.div variants={fadeUp} className="bg-surface p-10 md:p-12 rounded-[2rem] shadow-xl flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300">
              <div className="w-16 h-16 rounded-2xl bg-primary/10 text-primary flex items-center justify-center mb-8 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
              </div>
              <h3 className="text-2xl font-serif text-ink mb-4">Authentic Connection</h3>
            ...
            {/* Value 2 */}
            <motion.div variants={fadeUp} className="bg-surface p-10 md:p-12 rounded-[2rem] shadow-xl flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300">
              <div className="w-16 h-16 rounded-2xl bg-secondary/10 text-secondary flex items-center justify-center mb-8 group-hover:bg-secondary group-hover:text-white transition-colors duration-300">
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
              </div>
              <h3 className="text-2xl font-serif text-ink mb-4">Thoughtful Design</h3>
              <p className="text-[#55433c] leading-relaxed">
            ...
            <motion.div variants={fadeUp} className="bg-surface p-10 md:p-12 rounded-[2rem] shadow-xl flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-serif text-ink mb-4">Sustainable Craft</h3>
              <p className="text-[#55433c] leading-relaxed">
